...
function wpnoonan_resources() {
    ...
    wp_register_style( 'wpnoonan-css', get_stylesheet_directory_uri() . '/library/css/style.css', array(), 'v0.40', 'all' );
    ...
    wp_register_script( 'wpnoonan-js', get_stylesheet_directory_uri() . '/js/app.js?v0.4', false, '', true );
